...
<section>
      ...
      <div id="gamesGrid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <!-- Game Card Template -->
            <div class="game-card bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl overflow-hidden shadow-xl neon-border">
              <img src="18-img/xnxx.png" alt="Cumtube" class="w-full h-48 object-fit: cover">
              <div class="p-5">
                <h3 class="font-bold text-xl text-white mb-1">XNXX</h3>
                <p class="text-red-400 text-sm mb-4 font-semibold">FOR PHONES</p>
                <p class="text-cyan-400 text-sm mb-4 font-semibold">No ADS | No need account | Including Pinay</p>
                <a href="https://drive.google.com/file/d/1K0nnaYfhkZVvGaAKLLhD8Apyy9D-gqBG/view?usp=drive_link" class="inline-block bg-cyan-600 hover:bg-cyan-700 text-white font-semibold py-2 px-4 rounded-md shadow-md transition">Download</a>
              </div>
            </div>
